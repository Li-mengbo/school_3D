...
/*传入经度，返回基于模型的X坐标点
  ...
  *@return 基于模型的X坐标点
  *说明： 
  *模型大门的坐标为(x=12.375974221820515,z=-14.468876566816704,116.64861023,39.92165992)
  *模型会议楼坐标为(x=-27.090608147958815，z=12.540611062989646，116.64481759,39.91972215)
  */
        
 export function CalculationX(x) {
  const a = ( 12.375974221820515 - -27.090608147958815) / (116.64861023 - 116.64494634);            
